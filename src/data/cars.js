...
export const CARS = [
  ...
  { id: 'peugeot', brand: 'Peugeot',     name: '208',       lessons: 9,  cheer: 'Knap hoor! De groene Peugeot! Niveau 1 gehaald — jij kent de letters!' },
  { id: 'mini',    brand: 'MINI',        name: 'Cooper',    lessons: 12, cheer: 'Hoera! Je hebt de stoere Mini verdiend!' },
  { id: 'skoda',   brand: 'Škoda',       name: 'Karoq',     lessons: 15, cheer: 'Wauw! De zilveren Škoda! Niveau 2 gehaald — jij kunt klanken plakken!' },
  ...
  { id: 'sealu',   brand: 'BYD',         name: 'Seal U',    lessons: 25, cheer: 'Geweldig! De BYD is van jou! Niveau 3 gehaald — jij kunt woorden lezen!' },

  // ── Super auto's ──
  { id: 'porsche', brand: 'Porsche',     name: '911 GT3',   lessons: 30, super: true, cheer: 'SUPER AUTO! De zwarte Porsche racewagen! Niveau 4 gehaald — jij kunt alles lezen!' },
